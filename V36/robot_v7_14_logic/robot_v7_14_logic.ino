/*
 * ============================================================
 *  EC6090 MINI PROJECT 2026 — LINE FOLLOWING ROBOT v7.14
...
void setup() {
  ...
  Serial.println();
  Serial.println("============================================");
  Serial.println("  EC6090 Robot v7.14 — Full Logic");
  Serial.println("============================================");
...
void loop() {
  ...
  switch (currentState) {
    ...
    case STATE_AVOID_RED: {
      // DISABLE ultrasonic for the entire avoidance maneuver.
      // Without this, the robot reverses toward the cube,
      // re-detects it at < 6cm, stops, re-reads color, and
      // loops forever — never completing the bypass.
      ultrasonicEnabled = false;
      Serial.println("Ultrasonic DISABLED for avoidance");
      avoidObstacle();
      obstaclesAvoided++;
    ...
    case STATE_CARRY_TO_END: {
      ...
      if (dist > 2 && dist < DETECT_DIST_CM) {
        ...
        ultrasonicEnabled = false;   // disable before avoidance
        Serial.println("Ultrasonic DISABLED for carry avoidance");
        avoidObstacle();
        obstaclesAvoided++;
        changeState(STATE_REJOIN_LINE);
        break;
...
// ============================================================
//  END OF CODE v7.14 — EC6090 Mini Project 2026 — Full Logic
// ============================================================
