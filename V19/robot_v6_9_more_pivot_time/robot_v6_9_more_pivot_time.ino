/*
 * ============================================================
 *  EC6090 MINI PROJECT 2026 — LINE FOLLOWING ROBOT v6.9
 *  TUNE — INCREASED PIVOT TIME (300ms guard delay)
 * ============================================================
...
#define SHARP_TURN_SPEED 75   // pivot speed for tight corners — increased for more turn angle
...
void setup() {
  ...
  Serial.println();
  Serial.println("============================================");
  Serial.println("  EC6090 Robot v6.9 — 300ms Pivot Guard Delay");
  Serial.println("============================================");
...
void followLineAdaptive() {
  ...
  if (turning) {
    ...
    // Guard: wait at least 300ms before checking exit condition
