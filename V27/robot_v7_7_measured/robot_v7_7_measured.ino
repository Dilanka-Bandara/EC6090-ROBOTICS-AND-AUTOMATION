/*
 * ============================================================
 *  EC6090 MINI PROJECT 2026 — LINE FOLLOWING ROBOT v7.7
 *  MEASURED PATTERNS — 90° corners are 11110 / 01111
 * ============================================================
 ...
 *
 * ============================================================
 *  CHANGES FROM v7.6 → v7.7
 * ============================================================
 *
 *  PHYSICALLY MEASURED ON ARENA:
 *    The actual sensor patterns at a 90° corner are NOT
 *    11100 / 00111 as assumed in v7.6.
 *
 *    Measured patterns:
 *      90° LEFT  corner:  11110  (S1+S2+S3+S4 on, S5 off)
 *      90° RIGHT corner:  01111  (S1 off, S2+S3+S4+S5 on)
 *
 *    v7.6 assumed S4 was off on a left corner and S2 was off
 *    on a right corner. Measurement shows both are actually ON
 *    — the line covers 4 out of 5 sensors at a 90° corner on
 *    this arena with this sensor spacing.
 *
 *  FIX — TWO PATTERN DEFINITIONS UPDATED:
 *
 *    OLD (v7.6):
 ...
 *
 *    NEW (v7.7):
 *      sharp90Left  = (s1 && s2 && s3 && s4 && !s5)  = 11110
 *      sharp90Right = (!s1 && s2 && s3 && s4 && s5)  = 01111
 *
 *  FULL TRIGGER TABLE (v7.7):
 *
 *    Pattern   Meaning              Action
 *    ───────────────────────────────────────────────
 *    10000     45° left corner      Pivot RIGHT
 *    11110     90° left corner      Pivot RIGHT  ← updated
 *    00001     45° right corner     Pivot LEFT
 *    01111     90° right corner     Pivot LEFT   ← updated
 *    00000*    Missed corner        Backup + Pivot
 *    (* only if |lastError| >= 30)
 *
 *  EVERYTHING ELSE IDENTICAL TO v7.6. (slower corner entry)
 *
 ...
 *
 *  Author: EC6090 Mini Project 2026 — v7.7 Measured Patterns
 * ============================================================
 */
...
// Ultrasonic
#define DETECT_DIST_CM    10 //last was 20
...
void setup() {
  ...
  Serial.println();
  Serial.println("============================================");
  Serial.println("  EC6090 Robot v7.7 — Measured Patterns");
  Serial.println("============================================");
...
// ============================================================
//  END OF CODE v7.7 — EC6090 Mini Project 2026 — Measured Patterns
// ============================================================
