/*
 * ============================================================
 *  EC6090 MINI PROJECT 2026 — LINE FOLLOWING ROBOT v7.0
 *  TUNE — MAX SHARP TURN (speed=120, guard=500ms)
 * ============================================================
...
#define SHARP_TURN_SPEED 200  // pivot speed for tight corners — increased for sharper turn
...
void setup() {
  ...
  Serial.println();
  Serial.println("============================================");
  Serial.println("  EC6090 Robot v7.0 — Max Sharp Turn speed=120 guard=500ms");
  Serial.println("============================================");
